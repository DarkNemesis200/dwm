...
static const char *fonts[]          = { "monospace:size=10", "FontAwesome:pixelsize=20:antialias=true:autohint=true", "JoyPixels:pixelsize=10:antialias=true:autohint=true"  };
